...
//changed functions 
//switch case = used to preform dif actions w dif conditions 
...
function showConcertInfo(inputParameter){
    ...
    request(queryUrl, function(error, response, body) {
        ...
        // If the request is successful it will return this 
        //using !error if there is an error recognize it 
